...
saved_df = pd.read_csv("D:\\vscoded\\Reps\\Face-Recognition\\TEST_IT\\Attendance-System-Project\\5. Encodings\\encodings.csv")
...
path = "D:\\vscoded\\Reps\\Face-Recognition\\TEST_IT\\Attendance-System-Project\\6. Attendence\\With_Camera\\"
...
with st.expander("Create New Attendence Sheet"):
    ...
    if st.button("Create New Attendence Sheet"):
        ...
        df.to_csv("D:\\vscoded\\Reps\\Face-Recognition\\TEST_IT\\Attendance-System-Project\\6. Attendence\\With_Camera\\"+name_of_attendence_sheet+".csv",index=False)
...
df = pd.read_csv("D:\\vscoded\\Reps\\Face-Recognition\\TEST_IT\\Attendance-System-Project\\6. Attendence\\With_Camera\\"+name_of_attendence_sheet+".csv")
while start:
    _, frame = camera.read()
    ...
    if stop:
        ...
        try:
            df2.to_csv("D:\\vscoded\\Reps\\Face-Recognition\\TEST_IT\\Attendance-System-Project\\6. Attendence\\With_Camera\\"+name_of_attendence_sheet+".csv",index=False)
        except NameError:
            print("df2 not defined !!")
        break
